...
input0.addEventListener('focusout', confirmar0)
input0.addEventListener('focusout', confirmar3)

input1.addEventListener('focusout', confirmar1)
input1.addEventListener('focusout', confirmar3)

input2.addEventListener('focusout', confirmar2)
input2.addEventListener('focusout', confirmar3)

input3.addEventListener('focusout', confirmar1)
input3.addEventListener('focusout', confirmar4)

input4.addEventListener('focusout', confirmar1)
input4.addEventListener('focusout', confirmar4)

input5.addEventListener('focusout', confirmar2)
input5.addEventListener('focusout', confirmar4)

input6.addEventListener('focusout', confirmar0)
input6.addEventListener('focusout', confirmar5)

input7.addEventListener('focusout', confirmar1)
input7.addEventListener('focusout', confirmar5)

input8.addEventListener('focusout', confirmar2)
input8.addEventListener('focusout', confirmar5)
